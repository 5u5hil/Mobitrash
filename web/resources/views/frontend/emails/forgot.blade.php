<div style="max-width:700px; min-width: 320px; margin:0 auto; border:solid 2px #fff;background:url('{{ asset('public/Admin/dist/img/mobitrashback.jpg')}}')no-repeat; ">
  ...
  <div style="padding:10px; font-family:Arial, Helvetica, sans-serif; color:#484848; font-size:12px;  line-height:19px;height: 219px;">
    ...
    <span style="font:'Arial Black', Gadget, sans-serif;"><h2>Greetings from MobiTrash!</h2><h4><span>
                Looks like you've forgotten your password. To complete password reset process, click on the link below: <a href="{{route('user.password.reset')}}?id={{$user->var_code_enc}}" target="_BLANK" >Reset Password</a></span><br><br><span>Thanks,</span><br><span>Team MobiTrash</span></h4></span>
