        ...
        <div class="col-md-12">
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="line line-dashed b-b line-lg pull-in"></div>
                    <div class="form-group">
                        {!!Form::label('user','Maximum Gunny Bags Quantity',['class'=>'col-sm-2 required']) !!}
                        <div class="col-sm-10">
                            {!! Form::text('max_gunny_bags',null, ["class"=>'form-control', 'placeholder'=>'Maximum Gunny Bags Quantity', "required"]) !!}
                        </div>
                    </div>
                    <div class="line line-dashed b-b line-lg pull-in"></div>
                    <div class="form-group">
