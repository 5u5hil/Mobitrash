        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <div class="form-group payment_date" style="{{$payment->payment_made == 1? 'display: block;' : 'display: none;' }}">
                        {!!Form::label('user','Date of Payment',['class'=>'col-sm-2 required']) !!}
                        <div class="col-sm-10">
                            {!! Form::text('payment_date',null, ["class"=>'form-control datepicker', 'placeholder'=>'YYYY-MM-DD', "required", $payment->payment_made == 1? '' : 'disabled']) !!}
                        </div>
                    </div>                    
                    <div class="line line-dashed b-b line-lg pull-in"></div>              
                    <div class="form-group payment_remark" style="{{$payment->payment_made == 1? 'display: block;' : 'display: none;' }}">
